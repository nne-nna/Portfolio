        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-400 max-w-2xl mb-8">
              I am a full-stack developer with a background in Electronics and Computer Engineering, building responsive user interfaces and robust server-side applications. I enjoy turning ideas into complete digital products using React, Java, Spring Boot, and modern web technologies, with a strong focus on clean user experience and practical problem-solving.
            </p>
            <div className="flex space-x-4">
              ...
              <Link
                  to="/Ezidiegwu Nnenna Favour's Resume.pdf"
                  target="_blank"
